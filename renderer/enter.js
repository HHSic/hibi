...
const ALL = [
  ...
  { id: 'cat-rb', name: '회색 고양이', hint: '회색 고양이가 구석에 식빵 자세로 앉아 두리번거립니다' },
  { id: 'cat-rb-hero', name: '가운데 회색 고양이', hint: '회색 고양이가 가운데에 크게 앉고, 안내와 할 일 목록은 오른쪽 아래로 비켜 줍니다' },
  { id: 'cat-black', name: '까만 고양이', hint: '까만 고양이가 구석 바닥에 엎드려 있다가 고개를 들어 올려다봅니다' },
  { id: 'cat-black-hero', name: '가운데 까만 고양이', hint: '까만 고양이가 가운데에 크게 엎드리고, 안내와 할 일 목록은 오른쪽 아래로 비켜 줍니다' },
